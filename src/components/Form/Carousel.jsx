...
const Carousel = () => {
    return (
        <div id="default-carousel" className="relative w-full mt-14" data-carousel="slide">
            ...
            {/* Slider controls */}
            <button type="button" className="absolute top-0 start-0 z-30 -left-9  flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
            ...
            <button type="button" className="absolute top-0 end-0 z-30 -right-9 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
