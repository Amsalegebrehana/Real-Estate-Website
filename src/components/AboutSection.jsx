...
const AboutSection = () => {
    return (
        <div className='container'>
            ...
            <div className='flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row justify-between md:pl-14 py-14 align-center '>
                <div className=' text-left px-2 sm:px-10 md:px-0 lg:px-0 md:w-4/5 lg:w-2/5 z-1'>
                    ...
                    <div className="bg-white shadow-xl rounded-3xl w-4/5 flex p-7 space-x-10 align-center">
                        <img src={SmartHomIcon} alt='icon' />
                        <div className='text-left'>
                            <p className='text-colur1 text-base sm:text-lg md:text-lg lg:text-lg'>Donec porttitor euismod</p>
                    ...
                    <div className="bg-white shadow-xl rounded-3xl w-4/5 flex p-7 mt-5  space-x-9  align-center">
